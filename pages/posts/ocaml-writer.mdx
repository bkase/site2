...
The concept of knowledge has an interesting property: Once I know `a`, when presented with new information `b` I'll never[^6] un-know `a`. As a consequence, knowledge gives rise to a [semi-lattice](https://en.wikipedia.org/wiki/Semilattice).
